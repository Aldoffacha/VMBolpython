...
export default function AdminUsuarios() {
  ...
  const fetchUsuarios = useCallback(async () => {
    ...
    try {
      ...
      const params = new URLSearchParams({ pagina, por_pagina: 8, busqueda });
          ...
          {loading ? (
            ...
            <div style={styles.tableWrapper}>
              <table style={styles.table}>
                <thead>
                  <tr>
                    {["ID", "Nombre", "Correo", "Teléfono", "Dirección", "Registro", "Acciones"].map(h => (
                ...
                <tbody>
                  {clientes.length === 0 ? (
                    <tr><td colSpan={7} style={{ ...styles.td, textAlign: "center", color: "#a0a0a0", padding: 40 }}>No se encontraron usuarios</td></tr>
                  ) : clientes.map((c, i) => (
